...
@section('content')
    ...
    <div class="modal fade" id="newMenu" tabindex="-1" role="dialog" aria-labelledby="newMenuTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create a new Pack</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form action="/create/pack" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" required class="form-control" value="" name="unitPrice" step=".01"
                                id="unitPrice">
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                <li class="nav-item">
                    <a class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab" href="#menuTab" role="tab"
                        ...
                        <i class="ni ni-laptop text-sm me-2"></i> Packs
                    </a>
                </li>
                <li class="nav-item">
                                            ...
                                            @foreach ($packs as $pack)
                                                <tr>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold"> {{ $pack->id }} </span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <a href="{{ $pack->image }}" target="_blank">
                                                            <img src="{{ $pack->image }}" class="avatar avatar-sm me-3"
                                                                alt="user1">
                                                        </a>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold"> {{ $pack->name }} </span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">

                                                        <span class="text-xs font-weight-bold">
                                                            {{ $pack->unitPrice }} FCFA</span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold"> {{ $pack->created_at }}
                                                        </span>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="/pack/{{ $pack->id }}" class="mx-3"
                                                            data-bs-toggle="tooltip" data-bs-original-title="View pack">
                                                            <i class="fas fa-eye text-secondary"></i>
                                                        </a>
                                                        <a href="/pack/delete/{{ $pack->id }}" class="mx-3"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Delete pack">
