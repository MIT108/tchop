...
-- Dumping data for table tchopshop.customers: ~3 rows (approximately)
DELETE FROM `customers`;
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`id`, `firstName`, `lastName`, `phone`, `email`, `password`, `status`, `created_at`, `updated_at`) VALUES
	(2, 'daniel', 'b', '+237 6585286', 'b@b.com', '$2y$10$ZUgRXewjhpPpaZ7MdwQVk.Wmc0UZArQR0c0i7Xjqdyilxoe3DDF16', 'active', '2022-06-23 23:05:57', '2022-06-23 23:05:57'),
	(3, 'MIENDJEM', 'idriss', '+237 6585286', 'anderson@iaicameroun.com', '$2y$10$cC00hpqOcu5bFMoGXPqe/.1.eBvNVZn53thebqPDXy8sNuNKgiVBC', 'suspend', '2022-06-23 23:46:21', '2022-06-24 13:46:54'),
	(4, 'adrienne', 'Bra', '12345678', 'c@c.com', '$2y$10$aBDbcJt7Haigds12.0prb.q26YYn2tw1VnGDiLA5WOLRr9fNxjtxu', 'active', '2022-06-24 12:42:01', '2022-06-24 12:42:01');
...
-- Dumping data for table tchopshop.ingredients: ~2 rows (approximately)
DELETE FROM `ingredients`;
/*!40000 ALTER TABLE `ingredients` DISABLE KEYS */;
INSERT INTO `ingredients` (`id`, `name`, `image`, `created_at`, `updated_at`) VALUES
	(2, 'thierry miendjem', '1656147791vlcsnap-2020-11-13-17h01m26s689.png', '2022-06-24 19:24:13', '2022-06-25 09:03:11'),
	(3, 'Daniel Belong', '1656171281vlcsnap-2020-11-13-17h01m26s689.png', '2022-06-25 15:34:41', '2022-06-25 15:34:41'),
	(4, 'MIENDJEM Thierry Idris', '1656171317backgroundimage.jpg', '2022-06-25 15:35:17', '2022-06-25 15:35:17');
...
-- Dumping data for table tchopshop.menus: ~2 rows (approximately)
DELETE FROM `menus`;
/*!40000 ALTER TABLE `menus` DISABLE KEYS */;
INSERT INTO `menus` (`id`, `name`, `image`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'Daniel Belong', '1656175009logo.jpg', 'qwertuikmfdsdjeu', '2022-06-25 09:15:13', '2022-06-25 16:36:49');
...
-- Dumping data for table tchopshop.menu_contents: ~2 rows (approximately)
DELETE FROM `menu_contents`;
/*!40000 ALTER TABLE `menu_contents` DISABLE KEYS */;
INSERT INTO `menu_contents` (`id`, `menu_id`, `ingredient_id`, `created_at`, `updated_at`) VALUES
	(2, 1, 2, '2022-06-25 15:39:06', '2022-06-25 15:39:06'),
	(3, 1, 3, '2022-06-25 15:39:06', '2022-06-25 15:39:06');
...
-- Dumping data for table tchopshop.users: ~0 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `password`, `phone`, `location`, `about_me`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'admin@softui.com', '$2y$10$qAPcnl3JnDDyTj7vEV0xtOhfEOHO7pwlgjhxkodAu.nYC0Z4LHCMe', NULL, NULL, NULL, NULL, '2022-06-23 22:51:02', '2022-06-23 22:51:02');
